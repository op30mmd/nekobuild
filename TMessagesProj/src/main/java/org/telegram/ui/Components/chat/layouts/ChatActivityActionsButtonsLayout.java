...
public class ChatActivityActionsButtonsLayout extends LinearLayout {
    ...
    public ChatActivityActionsButtonsLayout(@NonNull Context context,
        ...
        replyButton.button = ChatActivityBlurredRoundButton.create(context, null,
            null, resourcesProvider, 0);
        replyButton.button.setOnClickListener(v -> {});
        ScaleStateListAnimator.apply(replyButton.button, .065f, 2f);

        selectButton.button = ChatActivityBlurredRoundButton.create(context, null,
                null, resourcesProvider, R.drawable.ic_select_between);
        ...
        forwardButton.button = ChatActivityBlurredRoundButton.create(context, null,
            null, resourcesProvider, 0);
